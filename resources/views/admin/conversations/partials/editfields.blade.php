...
<div class="px-12 pb-8 flex flex-col items-center w-10/12">
    ...
    <div class="w-full mb-2">
        ...
        <div class="flex items-center">
            <input style="cursor:pointer;" class="thematiques__checkbox" type="checkbox" id="{{ $thematique->name }}" name="thematiques[]" value="{{ $thematique->id }}" {{ $model->thematiques->contains($thematique->id) ? 'checked' : '' }}>
