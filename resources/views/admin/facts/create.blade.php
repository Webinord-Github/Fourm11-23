...
<div class="container flex flex-col items-end justify-start mt-10 py-8">
    <div class="formContainer flex flex-col items-center">
        ...
        <form class="w-full flex justify-center" action="{{ route('facts.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="px-12 pb-8 flex flex-col items-center w-10/12">
                ...
                <div class="w-full mb-2">
                    <div class="flex justify-center flex-col">
                        ...
                        <x-input id="source_name" class="block mt-1 w-full" type="text" name="source_name" :value="old('source_name')" required autofocus />
                    </div>
                </div>
                <div class="w-full mb-2">
                    <div class="flex justify-center flex-col">
                        <x-label for="source_url" :value="__('Lien de la source')"></x-label>
                        <x-input id="source_url" class="block mt-1 w-full" type="url" name="source_url" :value="old('source_url')" placeholder="https://example.com" required autofocus />
                    </div>
                </div>
