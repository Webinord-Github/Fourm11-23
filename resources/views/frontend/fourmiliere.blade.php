        ...
        <div class="first__content">
            <div class="text__content">
                ...
                <div class="list__container">
                    <li>Un forum pour échanger sur les meilleures pratiques, obtenir du soutien, bonifier vos
                        réflexions, partager vos bons coups, relever vos défis et créer des contacts avec d'autres
                        intervenant·es et bénévoles à travers la province ;</li>
                    ...
                    <li>Des nouvelles sur les formations, webinaires et autres activités à venir.</li>
                </div>
            </div>
            <div class="text__content">
                <h2>Raison d'être</h2>
                <h3><i>Pourquoi la fourmilière ?</i></h3>
                <div class="text flex-column">
                    <p class="text-center" style="margin: 10px 0px;">Une fourmilière et une communauté de pratique partagent plusieurs caractéristiques.</p>
                    <p><strong>Organisation</strong> : Les fourmis dans une fourmilière ont des rôles particuliers, chacune ayant une
                        tâche spécifique à accomplir pour le bien de la communauté. Dans une fourmilière, le rôle de
                        chacune des fourmis est déterminé par leurs forces, compétences et expertises, tout comme
                        dans une communauté de pratique. Chaque personne détient un rôle important au sein de La
                        Fourmilière ; les utilisateur·ices participent aux discussions, partagent des informations, relaient
                        les meilleures pratiques à leur milieu pendant que les administrateur·ices de la communauté
                        animent les échanges et les discussions et assurent la veille hebdomadaire de l'actualité pour
                        proposer des contenus adaptés.</p><br>
                    <p><strong>Collaboration</strong> : Dans une fourmilière, les fourmis collaborent étroitement pour accomplir leurs
                        tâches. Elles communiquent sans cesse et partagent des informations pour le bien de la
                        communauté. De même, dans cette communauté de pratique, les participant·es collaborent et
                        partagent leurs expériences, leurs connaissances et leurs ressources afin d'élaborer ensemble
                        les meilleures pratiques de prévention et de lutte à l'intimidation.</p><br>
                    <p><strong>Cohésion</strong> : Les fourmis forment une communauté soudée. Elles travaillent ensemble pour
                        protéger la reine et assurer la survie de la colonie. Au sein de La Fourmilière, les participant·es
                        sont uni·es par l'objectif commun de prévenir et de lutter contre l'intimidation.</p><br>
                    <p><strong>Adaptabilité</strong> : Les fourmis sont connues pour leur capacité à s'adapter à différents
                        environnements et à trouver ensemble des solutions novatrices pour résoudre les problèmes. Les
                        participant·es de cette communauté de pratique doivent tout autant se montrer ouvert·es au
                        changement et prêt·es à adopter de nouvelles stratégies pour faire face à l'intimidation.</p><br>
                    <p>La Fourmilière se veut un espace collaboratif dédié à toutes les personnes œuvrant au Québec
                        pouvant être confrontées à des enjeux liés à l'intimidation et voulant échanger sur les pratiques
                        de prévention et de lutte à l'intimidation. Chaque personne détient une expertise et une
                        perspective unique sur les enjeux liés à l'intimidation, alors le partage d'expériences et de savoirs
                        au sein de la communauté de pratique pourra provoquer des réflexions, enrichir et informer les
                        utilisateur·ices sur les meilleures pratiques en matière de prévention et de lutte à l'intimidation.
                        C'est à travers le dialogue et la mise en commun des forces des utilisateur·ices que la
                        communauté de pratique prendra vie.</p><br>
                    <p>Les personnes administratrices de La Fourmilière souhaitent soutenir les participant·es en
                        animant des échanges, en stimulant des discussions et en relayant des informations et des outils
                        adaptés aux préoccupations. Pour ce faire, les administrateur·ices visent la flexibilité,
                        l'adaptabilité et l'écoute des besoins des utilisateur·ices. La rétroaction des utilisateur·ices est
                        essentielle à toute étape afin de favoriser une collaboration efficiente et harmonieuse au sein de
                        la communauté de pratique.</p>
                </div>
            </div>
